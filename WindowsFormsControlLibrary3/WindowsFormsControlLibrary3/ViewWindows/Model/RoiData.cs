            ...
            if (type != null)
            {
                if (!(type == "ROIRectangle1"))
                {
                    if (!(type == "ROIRectangle2"))
                    {
                        if (!(type == "ROICircle"))
                        {
                            if (type == "ROILine")
                            {
                                ...
                                if (modelData != null)
                                {
                                    this._line = new Line(modelData[0].D, modelData[1].D, modelData[2].D, modelData[3].D);
                        ...
                        else
                        {
                            ...
                            if (modelData != null)
                            {
                                this._circle = new Circle(modelData[0].D, modelData[1].D, modelData[2].D);
                    ...
                    else
                    {
                        ...
                        if (modelData != null)
                        {
                            this._rectangle2 = new Rectangle2(modelData[0].D, modelData[1].D, modelData[2].D, modelData[3].D, modelData[4].D);
                ...
                else
                {
                    ...
                    if (modelData != null)
                    {
                        this._rectangle1 = new Rectangle1(modelData[0].D, modelData[1].D, modelData[2].D, modelData[3].D);
